...
public class BuffRun : MonoBehaviour
{
    ...
    IEnumerator FireBuff(float aggressivity)
    {
        ...
        fireBuffEnd = true;
        EventCenter.Broadcast(EventType.StatusBarHideOrShow, gameObject.GetInstanceID(), BuffType.灼烧, false);
    }
    IEnumerator ThunderBuff()
    {
        ...
        thunderBuffEnd = true;
        EventCenter.Broadcast(EventType.StatusBarHideOrShow, gameObject.GetInstanceID(), BuffType.感电, false);
    }
    IEnumerator WaterBuff()
    {
        ...
        waterBuffEnd = true;
        EventCenter.Broadcast(EventType.StatusBarHideOrShow, gameObject.GetInstanceID(), BuffType.减速, false);
    }
}
